...
<div class="center">
	...
	<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
		<span itemprop="title">Противопожарные двери</span>
	</div>
</div>
</nav>

<h1 class="page-title"><span>Противопожарные двери</span></h1>

<div class="configurator">

	<div class="single-config-block">
		<div class="single-door">
			<div class="coating">Противопожарные</div>
			<img class="" src="img/config-block-door.jpg" alt="">
		</div>	
		<div class="single-door">
			<div class="coating">Анти</div>
			<img class="" src="img/config-block-door-2.jpg" alt="">
		</div>	
	...
	<div class="single-config-block">
		<div class="single-door">
			<div class="coating">Технические</div>
			<img class="" src="img/config-block-door.jpg" alt="">
		</div>	
		<div class="single-door">
			<div class="coating">Технические с решеткой</div>
			<img class="" src="img/config-block-door-2.jpg" alt="">
		</div>	
		<div class="open-config">Конфигуратор</div>
		<div class="door-price">
	...
	<div class="single-config-block">
		<div class="single-door">
			<div class="coating">Двери в транспорт</div>
			<img class="" src="img/config-block-door.jpg" alt="">
		</div>	
		<div class="single-door">
			<div class="coating">Залюзи</div>
			<img class="" src="img/config-block-door-2.jpg" alt="">
		</div>	
		<div class="open-config">Конфигуратор</div>
		<div class="door-price">
...
<div class="center">
	<ul class="all-doors-ul"><li class="all-doors filter active" data-filter=".1, .2, .3, .4, .5, .6"><a href="#catalog-link">Все двери</a></li></ul>
	<ul class="filters-menu firedoor">
		<li class="filter" data-filter=".1"><span>Однопольные</span></li>
		<li class="filter" data-filter=".2"><span>Двупольные</span></li>
		<li class="filter" data-filter=".3"><span>Одноп-е стекло</span></li>
		<li class="filter" data-filter=".4"><span>Двуп-е стекло</span></li>	
		<li class="filter" data-filter=".5"><span>Одноп-е Антипаника</span></li>
		<li class="filter" data-filter=".6"><span>Двуп-е Антипаника</span></li>	
	</ul>
...
<div class="center">
	...
	<h2 class="content-title">Противопожарные двери</h2>
