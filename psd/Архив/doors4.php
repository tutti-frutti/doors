...
<div class="center">
	...
	<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
		<span itemprop="title">Технические двери</span>
	</div>
</div>
</nav>

<h1 class="page-title"><span>Технические двери</span></h1>
...
<div class="center">
	...
	<ul class="filters-menu">
		...
		<li class="filter" data-filter=".3"><span>Однопольные (стекло)</span></li>
		<li class="filter" data-filter=".4"><span>Двупольные (стекло)</span></li>
		<li class="filter" data-filter=".5"><span>С решеткой</span></li>	
	</ul>
...
<div class="center">
	...
	<h2 class="content-title">Технические двери</h2>
