...
<div class="center">
	...
	<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
		<span itemprop="title">Двери для загородного дома</span>
	</div>
</div>
</nav>

<h1 class="page-title"><span>Двери для загородного дома</span></h1>

<div class="configurator">

	<div class="single-config-block">
		<div class="single-door">
			<div class="coating">МДФ</div>
			<img class="" src="img/config-block-door.jpg" alt="">
		</div>	
		<div class="single-door">
			<div class="coating">Массив</div>
	...
	<div class="single-config-block">
		<div class="single-door">
			<div class="coating">Двухстворчатые</div>
			<img class="" src="img/config-block-door.jpg" alt="">
		</div>	
		<div class="single-door">
			<div class="coating">Двухстворчатые</div>
	...
	<div class="single-config-block">
		<div class="single-door">
			<div class="coating">Двухстворчатые, стекло</div>
			<img class="" src="img/config-block-door.jpg" alt="">
		</div>	
		<div class="single-door">
			<div class="coating">Двухстворчатые, ковка</div>
			<img class="" src="img/config-block-door-2.jpg" alt="">
		</div>	
		<div class="open-config">Конфигуратор</div>
		<div class="door-price">
...
<div class="center">
	...
	<h2 class="content-title">Двери для загородного дома</h2>
