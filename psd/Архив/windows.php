...
<div class="center">
	...
	<div itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
		<span itemprop="title">Окна ПВХ, AL, зимние сады</span>
	</div>
</div>
</nav>

<h1 class="page-title"><span>Окна ПВХ, AL, зимние сады</span></h1>

<div class="configurator">

	<div class="single-config-window">
		<div class="window-coating">Окна ПВХ и AL</div>
		<img src="img/config-block-window.png" alt="">
	</div>
	
	<div class="single-config-window">
		<div class="window-coating">Зимние сады</div>
		<img src="img/config-block-window2.png" alt="">
	</div>
...
<div class="center">
	<ul class="all-doors-ul"><li class="all-doors filter active" data-filter=".1, .2"><a href="#catalog-link">Все двери</a></li></ul>
	<ul class="filters-menu">
		<li class="filter" data-filter=".1"><span>Окна ПВХ и AL</span></li>
		<li class="filter" data-filter=".2"><span>Зимние сады</span></li>
	</ul>
</div>
</div>
...
<div class="center">
	...
	<h2 class="content-title">Окна ПВХ, AL, зимние сады</h2>
...
<div class="center">
	...
	<div class="single-product 1">
		<img src="img/catalog-window.jpg" alt="">
